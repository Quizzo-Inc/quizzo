...
public class Quizzo implements ActionListener {
	...
	String[] questoesPartida = {
								"Que c�digo faz parte do bloco try?",
								"Dado: int x[]; qual � o valor de x?",
								"Qual palavra-chave � usada para alocar mem�ria para um objeto rec�m-criado?",
								"Se voc� precisasse fazer com que uma vari�vel espec�fica pertencesse a uma classe, "
								+ "e nao a uma inst�ncia individual, que tipo de vari�vel usaria?"
	...
	String[][] opcoesPartida = {
								/*-----------------------QUESTAO 1-----------------------------------*/
								{	"Qualquer c�digo que tende a causar uma exce��o", 
									"Qualquer c�digo capaz de tratar uma exce��o", 
									"Qualquer c�digo que tende a imprimir os detalhes da exce��o", 
									"Qualquer c�digo que esteja protegido contra uma exce��o"		
								},
								/*-----------------------QUESTAO 2-----------------------------------*/
								{
									"1", "0", "nulo", "Algum n�mero aleatorio."
								},
								/*-----------------------QUESTAO 3-----------------------------------*/
								{
								...
								/*-----------------------QUESTAO 4-----------------------------------*/
								{	"Uma vari�vel privada", "Uma vari�vel local", "Uma vari�vel p�blica", "Uma vari�vel est�tica"
	...
	public void partida() {
		...
		textfield.setBounds(0, 0, 650, 50); // DEFINE A AREA DO TEXTO DO NUMERO DA QUEST�O
